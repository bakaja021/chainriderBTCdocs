...
In order to support TLSNotaryProof one needs to use [https://api-dot-vizlorepaymentprocessor.appspot.com]() instead of [https://api.chainrider.io]() domain in requests. Bold info might be stressed within documentation of ChainRider.
