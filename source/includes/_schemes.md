...
|event_type|String|Type of the event - ENUM {'ADDRESS', 'BLOCK', 'TRANSACTION'}. Please refer to [Event Types](#eventtypesheader) for more details.|
...
|retry|Integer|How many retry cycles have been attempted. When it reaches 28 the event is disabled|
